...
This will remove `/opt/vidhop` and the loader in `/usr/local/bin`. Your `~/Videos/VidHop` directory will **not** 
be removed. You can delete it manually with your file manager if necessary.
